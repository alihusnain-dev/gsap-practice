    ...
    return (
        <div>
            ...
            <div className="w-screen mt-12">
                ...
                <div className="w-screen mt-12">
                    <div className="h-52 w-52 bg-emerald-600 mb-8" id="box7"></div>
                    <div className="h-52 w-52 bg-amber-600 mb-8" id="box8"></div>
                    <div className="h-52 w-52 bg-blue-600 mb-8" id="box9"></div>
                </div>
            </div>
        </div>
    )
